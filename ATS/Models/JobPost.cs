...
namespace ATS.Models
{
    public class JobPost
    {
        ...
        [MaxLength(20, ErrorMessage = "Location cannot exceed 100 characters.")]
        ...
        [MaxLength(20, ErrorMessage = "Employment Type cannot exceed 50 characters.")]
